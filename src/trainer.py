...
class PeftTrainer(Trainer):
    ...
    def __init__(self, aux_loss_coeff=1e-3, **kwargs):
        """
    ...
    def compute_loss(self, model: PeftModel, inputs, return_outputs=False, num_items_in_batch: Optional[torch.Tensor] = None,):
        """
