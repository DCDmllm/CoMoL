...
def get_peft_model_state_dict(
    ...
    if config.peft_type in (PeftType.LORA, PeftType.MOLE, PeftType.ADAMOLE, PeftType.CoreLORA, PeftType.MoCoreLORA, PeftType.MoCoreLORASh, PeftType.DenseLORA, PeftType.MoLORA, PeftType.FlyLORA):
        bias = config.bias
        if bias == "none":
