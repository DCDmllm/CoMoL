...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', type=str, default='/data/workspace/projects/moe/datasets/eval_code',
        help='huggingface data id or local data path')
    parser.add_argument(
        '--max_new_tokens', type=int, default=400,
    ...
    model_name = re.sub(r'[^0-9a-zA-Z]', '-', os.path.basename(model_path).lower())
    ...
    for data_name in datasets:
        ...
        for response in tqdm(
            ...
            sample_responses = [res['generated_text'] for res in response]
        ...
        output_path = os.path.join(f'outputs/{model_name}', f'predictions/{data_name}_responses.jsonl')
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        new_dataset.to_json(output_path, lines=True)
        # break
